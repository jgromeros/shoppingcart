...
class VIPPriceCalculatorTest extends Specification {
    ...
    def "Calculate Price #scenario"() {
        ...
        "3 t-shirt"             | 91.78                 | buildCustomer()   | Map.of(buildProductPrice(), 3)
        ...
        "2 dresses 2 jeans"     | 248.63                | buildCustomer()   | Map.of(buildProductPrice(product: "Dress", price: BigDecimal.valueOf(80.75)), 2, buildProductPrice(product: "Jeans",price: BigDecimal.valueOf(65.50)), 2)
